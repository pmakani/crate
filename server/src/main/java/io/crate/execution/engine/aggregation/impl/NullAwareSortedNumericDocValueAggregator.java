...
public class NullAwareSortedNumericDocValueAggregator<T> extends SortedNumericDocValueAggregator<T> {

    public NullAwareSortedNumericDocValueAggregator(String columnName,
